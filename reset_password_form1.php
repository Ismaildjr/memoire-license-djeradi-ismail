...
background: radial-gradient(circle at 0.7% 1%, rgb(215, 248, 247) 0%, rgb(102, 188, 239) 100.2%);      }
    ...
    .card-header {
      background-color: blue; /* Changed the color to blue */
    ...
    .btn-blue { /* Changed the class name to btn-blue */
      background-color: blue; /* Changed the color to blue */
      border-color: blue; /* Changed the border color to blue */
    }

    .btn-blue:hover { /* Changed the class name to btn-blue */
      background-color: darkblue; /* Changed the hover color to dark blue */
      border-color: darkblue; /* Changed the hover border color to dark blue */
    }
            ...
            <?php
                  ...
                  if ($expirationTime >= time()) {
                    ...
                    <form method="POST" action="">
                      ...
                      <div class="text-center">
                        <button type="submit" name="submit" class="btn btn-blue btn-block">Reset Password</button> <!-- Changed the class name to btn-blue -->
                      </div>
                    </form>
                    <?php
                  } else {
              ...
              if (isset($_POST['submit'])) {
                ...
                if ($password === $confirmPassword) {
                  ...
                  echo '<div class="alert alert-success">Password reset successful. You can now <a href="AAB.php">login</a> with your new password.</div>';
                } else {
